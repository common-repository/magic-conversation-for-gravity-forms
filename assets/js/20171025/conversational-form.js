    ...
    var UserTextInput = (function (_super) {
        ...
        */
        ...
        UserTextInput.prototype.setFocusOnInput = function () {
          // console.log('setFocusOnInput init', cf.UserInputElement.preventAutoFocus, this.el.classList.contains("hide-input"));
            if (!cf.UserInputElement.preventAutoFocus && !this.el.classList.contains("hide-input")) {
              // console.log('setFocusOnInput do', this.inputElement);
...
(function (cf) {
    ...
    //flannian hack 11/14/2017
    window.ConversationalFormChatResponse = ChatResponse;
})(cf || (cf = {}));
    ...
    var ConversationalForm = (function () {
        function ConversationalForm(options) {
            ...
            if (this.formEl.getAttribute("cf-no-animation") == "")
              ...
              // console.log('preventAutoFocus', options.preventAutoFocus, this.formEl.getAttribute("cf-prevent-autofocus") == "");
