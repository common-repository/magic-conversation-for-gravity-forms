...
* 漏 2014 www.finalclap.com
* @copyright  2014 Vincent Par茅
* @author     Vincent Par茅
...
{
	public $html		    = null; // (string) Page URL
	...
	*/
	public function getFaviconUrl()
	{
		...
		// Default favicon URL
		$this->icoUrl = false;//$this->siteUrl.'favicon.ico';
	...
	/**
	* T茅l茅charge le favicon (et v茅rifie son existance au passage)
	*/
	...
	*/
	public static function downloadAs($url, &$info = null)
	{
		...
		curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.13; rv:62.0) Gecko/20100101 Firefox/62.0');
